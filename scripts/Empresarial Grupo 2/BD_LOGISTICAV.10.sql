...
INSERT INTO `tbl_asignacion_clientes` VALUES 
(1,101),
(1,102);
...
CREATE TABLE `tbl_clientes` (
  ...
  `Tipo` enum('Publico','Mayorista', 'Distribuidor') NOT NULL,
...
CREATE TABLE `tbl_orden_compra` (
  ...
  CONSTRAINT `Tbl_orden_compra_ibfk_1` FOREIGN KEY (`fk_id_proveedor`) 
    REFERENCES `tbl_proveedor` (`pk_id_proveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tbl_detalle_orden_compra` (
  ...
  CONSTRAINT `Tbl_detalle_orden_compra_ibfk_1` FOREIGN KEY (`fk_id_orden_compra`) 
    REFERENCES `Tbl_orden_compra` (`pk_id_orden_compra`) ON DELETE CASCADE,
  CONSTRAINT `Tbl_detalle_orden_compra_ibfk_2` FOREIGN KEY (`fk_id_producto`) 
    REFERENCES `tbl_producto` (`pk_id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tbl_compra` (
  ...
  KEY `fk_id_proveedor` (`fk_id_proveedor`),
  KEY `fk_id_orden_compra` (`fk_id_orden_compra`),
  CONSTRAINT `Tbl_compra_ibfk_1` FOREIGN KEY (`fk_id_proveedor`) 
    REFERENCES `tbl_proveedor` (`pk_id_proveedor`),
  CONSTRAINT `Tbl_compra_ibfk_2` FOREIGN KEY (`fk_id_orden_compra`) 
    REFERENCES `Tbl_orden_compra` (`pk_id_orden_compra`),
  CONSTRAINT `uq_factura_proveedor` UNIQUE 
    (`cmp_serie_factura`,`cmp_numero_factura`,`fk_id_proveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tbl_detalle_compra` (
  ...
  KEY `fk_id_producto` (`fk_id_producto`),
  CONSTRAINT `Tbl_detalle_compra_ibfk_1` FOREIGN KEY (`fk_id_compra`) 
    REFERENCES `Tbl_compra` (`pk_id_compra`) ON DELETE CASCADE,
  CONSTRAINT `Tbl_detalle_compra_ibfk_2` FOREIGN KEY (`fk_id_producto`) 
    REFERENCES `tbl_producto` (`pk_id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tbl_cuentas_por_pagar` (
  ...
  KEY `fk_id_compra` (`fk_id_compra`),
  CONSTRAINT `tbl_cuentas_por_pagar_ibfk_1` 
    FOREIGN KEY (`fk_id_compra`) 
    REFERENCES `tbl_compra` (`pk_id_compra`)
    ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Tbl_Cuentas_Por_Cobrar_Detalle (
    ...
    Cmp_Monto_Pagado                 FLOAT        NOT NULL DEFAULT 0.00,
    Cmp_Saldo_Pendiente              FLOAT        NOT NULL DEFAULT 0.00,

    PRIMARY KEY (Pk_Id_Cuenta_Por_Cobrar_Detalle),
    FOREIGN KEY (Fk_Id_Cuenta_Por_Cobrar) REFERENCES Tbl_Cuentas_Por_Cobrar(Pk_Id_Cuenta_Por_Cobrar),
    FOREIGN KEY (Fk_Id_Tipo_Operacion)    REFERENCES Tbl_Tipo_Operacion_CXC(pk_tipo_operacion_cxc_id)
);
...
-- Dump completed on 2026-04-21 18:42:04
