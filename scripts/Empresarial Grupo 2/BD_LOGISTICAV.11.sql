CREATE DATABASE  IF NOT EXISTS `bd_logistica` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_logistica`;
...
CREATE TABLE `tbl_clientes` (
  ...
  `Cmp_Tipo` enum('Publico','Mayorista', 'Distribuidor') NOT NULL,
...
INSERT INTO `tbl_clientes` VALUES (1,'20196709','Ernesto','Samayoa','41017988','ernesto1@miumg.edu.gt',500,'zona 18','Publico','Activo');
...
CREATE TABLE `tbl_compra` (
  ...
  `cmp_estado` enum('pendiente','parcial','pagado') DEFAULT 'pendiente',
...
INSERT INTO `tbl_compra` VALUES (2001,1001,NULL,'A','FAC-001','2026-04-01 10:00:00',30,'2026-05-01 00:00:00','credito',1500.00,1500.00,'pendiente'),(2002,1002,NULL,'A','FAC-002','2026-04-05 11:30:00',15,'2026-04-20 00:00:00','credito',850.00,850.00,'parcial'),(2003,1003,NULL,'B','FAC-003','2026-04-10 09:15:00',0,NULL,'contado',2300.00,2300.00,'pagado'),(2004,1001,NULL,'C','FAC-004','2026-04-15 14:00:00',45,'2026-05-30 00:00:00','credito',3200.00,3200.00,'pendiente');
...
CREATE TABLE `tbl_cuentas_por_cobrar` (
  ...
  `Cmp_Estado` enum('Pendiente','Pagado','Vencido','Anulado') NOT NULL DEFAULT 'Pendiente',
...
INSERT INTO `tbl_cuentas_por_pagar` VALUES (3001,2001,'2026-04-01 10:00:00','2026-05-01 00:00:00',1500,'pendiente'),(3002,2002,'2026-04-05 11:30:00','2026-04-20 00:00:00',850,'parcial'),(3003,2003,'2026-04-10 09:15:00',NULL,2300,'pagado'),(3004,2004,'2026-04-15 14:00:00','2026-05-30 00:00:00',3200,'pendiente');
...
INSERT INTO `tbl_cuentas_por_pagar_detalle` VALUES (1,3002,'abono','AB-001','2026-04-10',300,550),(2,3003,'pago_total','PG-001','2026-04-10',2300,0);
...
CREATE TABLE `tbl_detalle_compra` (
  ...
  CONSTRAINT `Tbl_detalle_compra_ibfk_1` FOREIGN KEY (`fk_id_compra`) REFERENCES `tbl_compra` (`pk_id_compra`) ON DELETE CASCADE,
  CONSTRAINT `Tbl_detalle_compra_ibfk_2` FOREIGN KEY (`fk_id_producto`) REFERENCES `tbl_producto` (`pk_id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_detalle_orden_compra` (
  ...
  KEY `fk_id_orden_compra` (`fk_id_orden_compra`),
  KEY `fk_id_producto` (`fk_id_producto`),
  CONSTRAINT `Tbl_detalle_orden_compra_ibfk_1` FOREIGN KEY (`fk_id_orden_compra`) REFERENCES `tbl_orden_compra` (`pk_id_orden_compra`) ON DELETE CASCADE,
  CONSTRAINT `Tbl_detalle_orden_compra_ibfk_2` FOREIGN KEY (`fk_id_producto`) REFERENCES `tbl_producto` (`pk_id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_movimiento_inventario_detalle` VALUES (1,1,50),(2,2,30),(3,3,100),(4,4,10),(5,5,5),(6,3,3),(6,4,5),(7,2,6),(7,3,2);
...
CREATE TABLE `tbl_orden_compra` (
  ...
  KEY `fk_id_proveedor` (`fk_id_proveedor`),
  CONSTRAINT `Tbl_orden_compra_ibfk_1` FOREIGN KEY (`fk_id_proveedor`) REFERENCES `tbl_proveedor` (`pk_id_proveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_ventas` (
  ...
  CONSTRAINT `fk_ventas_cliente` FOREIGN KEY (`Fk_Id_Cliente`)
    REFERENCES `tbl_clientes` (`Pk_Id_Cliente`)
    ON DELETE CASCADE ON UPDATE CASCADE,

  CONSTRAINT `fk_ventas_sucursal`FOREIGN KEY (`Fk_Id_Sucursal`)
    REFERENCES `tbl_sucursales` (`Pk_Id_Sucursal`)
    ON DELETE CASCADE ON UPDATE CASCADE
...
--
-- Dumping events for database 'bd_logistica'
--

--
-- Dumping routines for database 'bd_logistica'
--
...
-- Dump completed on 2026-04-27  8:46:59
